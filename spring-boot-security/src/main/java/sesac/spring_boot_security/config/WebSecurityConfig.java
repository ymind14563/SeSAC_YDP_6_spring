package sesac.spring_boot_security.config;
...
import sesac.spring_boot_security.security.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(withDefaults()) // cors 설정 (기본으로)
                ...
                // REST API 서버에서는 일반적으로 CSRF 보호가 필요없어서 끔
                .csrf(CsrfConfigurer::disable)

                // JWT 를 사용하고 있으므로 세션 관리 하지 않음
