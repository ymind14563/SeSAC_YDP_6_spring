...
/*
    ...
    // select * from user where username %XX% or email like %XX%
...
*/
    ...
    // - 단, JPA 는 테이블명이 아니라 객체 위주로 돌아가니 객체(Entity) 이름 사용해야 함
    // - nativeQuery 옵션
    // : SQL 문 자체를 사용하는 거라 DBMS 에 종속적이게 됨 (ORM 특징을 활용하기 어려움)
    ...
    // 참고. CASE WHEN (조건) THEN (결과1) ELSE (결과2) END : SQL 조건문
