package sesac.spring_boot_default.controller._01_thymeleaf;
...
public class HelloController {
    ...
    public String getHi(Model model) {
        // Model model
        // - Spring MVC 가 제공하는 타입 (View 에 값을 전달하는 상자 역할, MVC 의 Model 을 의미 X, 우연히 같을 뿐)
